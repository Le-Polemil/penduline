 ...
 *
 * 1. **Le tracé est recopié depuis `apps/web/public/icon.svg`.** Ce fichier fait
 *    foi pour le dessin et reste strictement statique — il sert de favicon, et
 *    une SVG animée chargée comme favicon s'anime dans certains navigateurs.
 *    Le jumeau web de ce composant (`apps/web/src/components/Loader.tsx`) porte
 *    le même tracé : toute retouche graphique doit être reportée aux deux.
 *
